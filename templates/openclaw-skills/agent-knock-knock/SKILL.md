...
- `AKK status <conversation-id>`: call `agent_knock_knock_status`. For terminal-controlled screen state, current tmux reachability, or approval prompt inspection, call `agent_knock_knock_terminal_status`.
