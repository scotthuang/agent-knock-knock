...
import {
  ...
  acceptedDispatchExpectation,
  acceptedTurnCanBeStalled,
  bindingCompatible,
  completionClaim,
  ledgerDispatchAuthorityError,
  ledgerDispatchCoreAuthorityExact,
  ledgerDispatchReceiptAuthority,
  localNotApplicable,
  processDisposition,
  required,
  stateDispatchAuthorityError,
  stateDispatchCoreAuthorityExact,
  stateDispatchReceiptAuthorityExact,
  submissionFacts,
  takeoverFor,
  unchangedVerifiedDead,
  validTimestamp,
  type VerifiedDeadDispatchRequest
} from "./terminal-dispatch-recovery-authority.js";
import {
