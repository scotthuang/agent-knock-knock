...
import {
  assertDispatchCallbackRouteAuthority,
  assertImmutableCallbackTransport,
  createManagedCallbackEnvelope,
  resolvedDeliveryOptions,
  resolveCallbackGatewayRoute,
  resolveManagedCallbackRoute,
  type CallbackPreparationOptions
} from "./callback-route-service.js";
export { resolveCallbackGatewayRoute } from "./callback-route-service.js";
export type { CallbackGatewayRouteCandidate,
  CallbackPreparationOptions } from "./callback-route-service.js";
import {
  callbackOutboxEvent,
  callbackOutboxField,
