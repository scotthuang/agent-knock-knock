...
export function claudeBootstrapPrompt(options: Omit<BootstrapPromptOptions, "executorName">): string {
...
export function executorBootstrapPrompt({ callbackCommand, executorName = "the coding agent", softLimit = 50, hardLimit = 100 }: BootstrapPromptOptions): string {
